...
//            player->learnClassLevelSpells(false);
            ...
            {
                player->learnSpellHighRank(7328);
                player->learnSpellHighRank(13819);
            }
            if (player->getClass() == CLASS_SHAMAN)
            {
                player->learnSpellHighRank(3599);
                player->learnSpellHighRank(5394);
                player->learnSpellHighRank(8071);
            }
...
const std::vector<uint32> Lvl80BiS_PriestShadow         = { 37684, 40680, 37673, 41610, 39523, 37361, 39530, 40696, 37854, 44202, 40585, 43253, 40682, 37873, 41384, 40698, 37177 };
...
const std::vector<uint32> Lvl80BiS_PaladinRetribution   = { 39633, 39634, 41386, 40678, 44195, 37647, 41355, 40694, 37193, 44306, 44935, 37642, 42987, 37166, 37852, 38362 , 41257};
...
const std::vector<uint32> Lvl80BiS_WarriorFuryArms      = { 41386, 40678, 44195, 37647, 39606, 41355, 39609, 40694, 37193, 44306, 42642, 44935, 42987, 40684, 37852, 37852, 37191, 44203, 37642, 41257 };
const std::vector<uint32> Lvl80BiS_WarriorProtection    = { 41387, 40679, 37635, 37728, 43740, 37620, 39622, 40689, 43500, 44201, 42643, 37784, 36993, 37220, 37401, 40701, 41168, 39611};
const std::vector<uint32> Lvl80BiS_DruidFeralCat        = { 37293, 39557, 39554, 40678, 37139, 43406, 44203, 40694, 37644, 44297, 40586, 42642, 44253, 40684, 37883, 40713 };
...
const std::vector<uint32> Lvl80BiS_DruidResto           = { 43751, 43822, 37149, 42023, 37673, 41610, 37361, 37643, 37791, 44202, 37694, 37192, 37657, 40685, 37360, 38366, 39538, 39543 };
const std::vector<uint32> Lvl80BiS_Rogue                = { 37293, 40678, 37139, 43566, 39558, 44203, 39560, 40694, 37644, 44297, 37642, 40586, 44253, 40684, 37856, 37667, 37191, 37693 };
...
const std::vector<uint32> Lvl80BiS_Warlock              = { 37684, 40680, 37673, 41610, 43790, 37361, 39500, 40696, 37854, 44202, 43253, 37694, 37873, 40682, 37360, 37177, 37721, 40698, 39497 };
...
const std::vector<uint32> Lvl80BiS_DeathknightUnholy    = { 41386, 42645, 37627, 37647, 39617, 41355, 39618, 40688, 37193, 43402, 44935, 43251, 42987, 37390, 40867, 41257 };
