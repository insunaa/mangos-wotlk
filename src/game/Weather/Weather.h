...
// enum WeatherState
// {
//     WEATHER_STATE_FINE              = 42,
//     WEATHER_STATE_LIGHT_RAIN        = 42,
//     WEATHER_STATE_MEDIUM_RAIN       = 42,
//     WEATHER_STATE_HEAVY_RAIN        = 42,
//     WEATHER_STATE_LIGHT_SNOW        = 42,
//     WEATHER_STATE_MEDIUM_SNOW       = 42,
//     WEATHER_STATE_HEAVY_SNOW        = 42,
//     WEATHER_STATE_LIGHT_SANDSTORM   = 42,
//     WEATHER_STATE_MEDIUM_SANDSTORM  = 42,
//     WEATHER_STATE_HEAVY_SANDSTORM   = 42,
//     WEATHER_STATE_THUNDERS          = 42,
//     WEATHER_STATE_BLACKRAIN         = 42
// };

// enum WeatherState
// {
//     WEATHER_STATE_FINE              = 90,
//     WEATHER_STATE_LIGHT_RAIN        = 90,
//     WEATHER_STATE_MEDIUM_RAIN       = 90,
//     WEATHER_STATE_HEAVY_RAIN        = 90,
//     WEATHER_STATE_LIGHT_SNOW        = 90,
//     WEATHER_STATE_MEDIUM_SNOW       = 90,
//     WEATHER_STATE_HEAVY_SNOW        = 90,
//     WEATHER_STATE_LIGHT_SANDSTORM   = 90,
//     WEATHER_STATE_MEDIUM_SANDSTORM  = 90,
//     WEATHER_STATE_HEAVY_SANDSTORM   = 90,
//     WEATHER_STATE_THUNDERS          = 90,
//     WEATHER_STATE_BLACKRAIN         = 90
// };

enum WeatherState
{
    WEATHER_STATE_FINE              = 5,
    WEATHER_STATE_LIGHT_RAIN        = 5,
    WEATHER_STATE_MEDIUM_RAIN       = 5,
    WEATHER_STATE_HEAVY_RAIN        = 5,
    WEATHER_STATE_LIGHT_SNOW        = 5,
    WEATHER_STATE_MEDIUM_SNOW       = 5,
    WEATHER_STATE_HEAVY_SNOW        = 5,
    WEATHER_STATE_LIGHT_SANDSTORM   = 5,
    WEATHER_STATE_MEDIUM_SANDSTORM  = 5,
    WEATHER_STATE_HEAVY_SANDSTORM   = 5,
    WEATHER_STATE_THUNDERS          = 5,
    WEATHER_STATE_BLACKRAIN         = 5
};
